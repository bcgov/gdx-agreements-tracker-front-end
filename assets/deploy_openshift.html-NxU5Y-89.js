...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,8);function m(v,y){const a=p("ExternalLinkIcon");return l(),i("div",null,[u,n("p",null,[s("In order to deploy to a kubernetes cluster, follow these steps. "),n("a",r,[s("Kustomize"),e(a)]),s(" is used to deploy to Kubernetes. You will also need the "),n("a",d,[s("OpenShift CLI"),e(a)])]),k])}const h=t(c,[["render",m],["__file","deploy_openshift.html.vue"]]),_=JSON.parse('{"path":"/guide/GettingStarted/deploy_openshift.html","title":"Deploying to OpenShift","lang":"en-US","frontmatter":{},"headers":[{"level":2,"title":"Deploying Gdx Agreements tracker to OpenShift","slug":"deploying-gdx-agreements-tracker-to-openshift","link":"#deploying-gdx-agreements-tracker-to-openshift","children":[{"level":3,"title":"kustomization.yaml","slug":"kustomization-yaml","link":"#kustomization-yaml","children":[]},{"level":3,"title":"patch.yaml","slug":"patch-yaml","link":"#patch-yaml","children":[]},{"level":3,"title":"Deploying","slug":"deploying","link":"#deploying","children":[]}]}],"git":{"contributors":[{"name":"ASpiteri-BCGov","email":"49036255+ASpiteri-BCGov@users.noreply.github.com","commits":1}]},"filePathRelative":"guide/GettingStarted/deploy_openshift.md"}');export{h as comp,_ as data};
