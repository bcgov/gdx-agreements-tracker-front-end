...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,8);function m(v,y){const s=p("ExternalLinkIcon");return l(),i("div",null,[u,n("p",null,[a("In order to deploy to a kubernetes cluster, follow these steps. "),n("a",r,[a("Kustomize"),e(s)]),a(" is used to deploy to Kubernetes. You will also need the "),n("a",d,[a("OpenShift CLI"),e(s)])]),k])}const h=t(c,[["render",m],["__file","deploy_openshift.html.vue"]]),_=JSON.parse('{"path":"/guide/GettingStarted/deploy_openshift.html","title":"Deploying to OpenShift","lang":"en-US","frontmatter":{},"headers":[{"level":2,"title":"Deploying Gdx Agreements tracker to OpenShift","slug":"deploying-gdx-agreements-tracker-to-openshift","link":"#deploying-gdx-agreements-tracker-to-openshift","children":[{"level":3,"title":"kustomization.yaml","slug":"kustomization-yaml","link":"#kustomization-yaml","children":[]},{"level":3,"title":"patch.yaml","slug":"patch-yaml","link":"#patch-yaml","children":[]},{"level":3,"title":"Deploying","slug":"deploying","link":"#deploying","children":[]}]}],"git":{"contributors":[{"name":"Alex Carmichael","email":"carmichael.alexander@gmail.com","commits":1}]},"filePathRelative":"guide/GettingStarted/deploy_openshift.md"}');export{h as comp,_ as data};
