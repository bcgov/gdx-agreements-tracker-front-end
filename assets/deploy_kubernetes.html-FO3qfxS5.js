import{_ as e,r as t,o as l,c as p,b as n,d as a,e as i,a as c}from"./app-87kVuQ1p.js";const o={},u=n("h1",{id:"deploying-to-kubernetes",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#deploying-to-kubernetes"},[n("span",null,"Deploying to Kubernetes")])],-1),r={href:"https://kustomize.io/",target:"_blank",rel:"noopener noreferrer"},d=c(`<ul><li>Create a folder for your deployment for this example we use <code>deployment</code></li><li>Add a <code>kustomization.yaml</code> and a <code>patch.yaml</code> to your deployment</li><li>Copy the sample code into these files and add configuration and secretes</li><li>Create images for your deployment, which needs to be accessible by your deployment, and also match the architecture of kubernetes cluster (amd/arm) <ul><li>Instructions on how to build images TBD</li></ul></li><li>View and test your deployment run <code>kubectl kustomize ./deployment</code></li><li>deploy your deployment <code>kubectl apply -k ./deployment</code></li></ul><h2 id="deploying-gdx-agreements-tracker-to-kubernetes" tabindex="-1"><a class="header-anchor" href="#deploying-gdx-agreements-tracker-to-kubernetes"><span>Deploying GDX Agreements Tracker to Kubernetes</span></a></h2><h3 id="kustomization-yaml" tabindex="-1"><a class="header-anchor" href="#kustomization-yaml"><span>kustomization.yaml</span></a></h3><div class="language-yaml line-numbers-mode" data-ext="yml" data-title="yml"><pre class="language-yaml"><code><span class="token comment">#/deployment/kustomization.yaml</span>
        ...
        <span class="token punctuation">-</span> <span class="token key atrule">name</span><span class="token punctuation">:</span> app
          <span class="token key atrule">env</span><span class="token punctuation">:</span>
            ...
            <span class="token punctuation">-</span> <span class="token key atrule">name</span><span class="token punctuation">:</span> REACT_APP_KEYCLOAK_REALM
              <span class="token key atrule">value</span><span class="token punctuation">:</span> <span class="token string">&quot;&quot;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,6);function k(m,v){const s=t("ExternalLinkIcon");return l(),p("div",null,[u,n("p",null,[a("In order to deploy to a kubernetes cluster, follow these steps. "),n("a",r,[a("Kustomize"),i(s)]),a(" is used to deploy to Kubernetes.")]),d])}const y=e(o,[["render",k],["__file","deploy_kubernetes.html.vue"]]),_=JSON.parse('{"path":"/guide/GettingStarted/deploy_kubernetes.html","title":"Deploying to Kubernetes","lang":"en-US","frontmatter":{},"headers":[{"level":2,"title":"Deploying GDX Agreements Tracker to Kubernetes","slug":"deploying-gdx-agreements-tracker-to-kubernetes","link":"#deploying-gdx-agreements-tracker-to-kubernetes","children":[{"level":3,"title":"kustomization.yaml","slug":"kustomization-yaml","link":"#kustomization-yaml","children":[]},{"level":3,"title":"patch.yaml","slug":"patch-yaml","link":"#patch-yaml","children":[]}]}],"git":{"contributors":[{"name":"Alex Carmichael","email":"carmichael.alexander@gmail.com","commits":1}]},"filePathRelative":"guide/GettingStarted/deploy_kubernetes.md"}');export{y as comp,_ as data};
